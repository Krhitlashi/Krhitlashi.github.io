...
while True:
    document["weu"] <= html.P("j͑ʃɹ ʃᴜ }ʃᴜ ſɭɔʞ ꞁȷ̀ɔƽ ꞁȷ̀ɜ ı],ɹ ſןɔ ᶅſᴜ |ꞁȷ̀ᴜ ŋᷠɹ ꞁȷ̀ɔƽ j͑ʃɹ ʃᴜ }ʃᴜ ⸙ ⸙|")
    ល៏មារ = document["saweu"].value  # Get the input text

    ត្លាកាកល៏មារ = ថេខាវេកិភ(ល៏មារ)
    for ជាងាសៃអេស្កេក in ង៏កិ១សៃអេស្កេក:
        ត្លាកាកល៏មារ = ត្លាកាកល៏មារ.replace(ជាងាសៃអេស្កេក, "")
    document["weu"] <= html.P("")
    document["weu"] <= html.P("|ꞁȷ̀ɜ ı],ɹ ſןɔ ᶅſᴜ|")
    document["weu"] <= html.P(ត្លាកាកល៏មារ)
    document["weu"] <= html.P("")